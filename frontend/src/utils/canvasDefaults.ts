...
const SEED_META_TAG = "storydeck-default-seed-v5";

const GITHUB_URL = "https://github.com/MohammedMoota/storydeck-studio";
// const DEVPOST_URL = "https://devpost.com/software/flowboard-bdpqzg"; // Removed
...
export function seedDefaultCanvas(editor: Editor, frameId?: TLShapeId | null) {
  ...
  addText("StoryDeck", leftColumnX, topY - 60, { size: "xl" }, 2);
  addText(
  ...
  addText(`Star our GitHub! \n${GITHUB_URL}`, -1000, 300, {
    size: "l",
    font: "mono",
  });

  addText(`Created by Mohammed Moota`, -800, -100, { size: "l", font: "mono" });
