...
const GITHUB_REPO = "https://github.com/MohammedMoota/storydeck-studio";

const builders = [
  { name: "Mohammed Moota", url: "https://github.com/MohammedMoota" },
];
    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center">
      ...
      <div className="relative z-10 w-full max-w-lg mx-4 bg-zinc-900 rounded-2xl p-8 shadow-2xl border border-zinc-800">
        ...
        <h2 className="text-2xl font-bold text-white text-center mb-6 font-ananda">
          <span className="text-brand-pink">StoryDeck</span>
        </h2>

        {/* Description */}
        <p className="text-zinc-400 text-center mb-6 leading-relaxed">
          StoryDeck is a video storyboarding tool that transforms your sketches
        ...
        <p className="text-zinc-400 text-center text-sm mb-6 leading-relaxed">
          StoryDeck is open-source and easy to self-host. Check out the repo and give us a star!
        </p>
