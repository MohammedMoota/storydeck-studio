...
class VertexService:
    def __init__(self):
        ...
        try:
            ...
            self.available = True
            print("VertexService initialized successfully with Google Cloud credentials.")
        except Exception as e:
            print(f"WARNING: VertexService could not initialize: {e}")
            print("AI features will not be available. Please set up Google Cloud credentials.")
